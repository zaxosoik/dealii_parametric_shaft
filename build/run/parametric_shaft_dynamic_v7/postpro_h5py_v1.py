...
##print(table)
# Open the HDF5 file
with h5py.File("solution_3.000000.h5", "r") as f: # type: ignore
...
data_grouped_max_stress = data_stress.groupby('x_coordinates').max().reset_index()
...
data_grouped_max_deform = data_deform.groupby('x_coordinates').max().reset_index()
