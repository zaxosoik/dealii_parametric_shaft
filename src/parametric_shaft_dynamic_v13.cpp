...
namespace ParametricShaft
{
  ...
  namespace Parameters
  {
    ...
    struct Bearings
    {
        ...
        double z_spring_x_max_journal;
        double z_spring_x_min_journal;
        double z_spring_y_max_journal;
        double z_spring_y_min_journal;
        double z_damper_z_max_journal;
        double z_damper_z_min_journal;
        double k_equiv_y_journal;
        double y_spring_x_max_journal;
        double y_spring_x_min_journal;
        double y_spring_y_max_journal;
        double y_spring_y_min_journal;
        double y_spring_z_max_journal;
        double y_spring_z_min_journal;
        ...
        double z_spring_x_max_tailtube;
        double z_spring_x_min_tailtube;
        double z_spring_y_max_tailtube;
        double z_spring_y_min_tailtube;
        double z_spring_z_max_tailtube;
        double z_spring_z_min_tailtube;
        double k_equiv_y_tailtube;
        double y_spring_x_max_tailtube;
        double y_spring_x_min_tailtube;
        double y_spring_y_max_tailtube;
        double y_spring_y_min_tailtube;
        double y_spring_z_max_tailtube;
        double y_spring_z_min_tailtube;
        ...
        double z_spring_x_max_sterntube;
        double z_spring_x_min_sterntube;
        double z_spring_y_max_sterntube;
        double z_spring_y_min_sterntube;
        double z_spring_z_max_sterntube;
        double z_spring_z_min_sterntube;
        double k_equiv_y_sterntube;
        double y_spring_x_max_sterntube;
        double y_spring_x_min_sterntube;
        double y_spring_y_max_sterntube;
        double y_spring_y_min_sterntube;
        double y_spring_z_max_sterntube;
        double y_spring_z_min_sterntube;
        ...
        double z_spring_x_max_engine;
        double z_spring_x_min_engine;
        double z_spring_y_max_engine;
        double z_spring_y_min_engine;
        double z_spring_z_max_engine;
        double z_spring_z_min_engine;
        double k_equiv_y_engine;
        double y_spring_x_max_engine;
        double y_spring_x_min_engine;
        double y_spring_y_max_engine;
        double y_spring_y_min_engine;
        double y_spring_z_max_engine;
        double y_spring_z_min_engine;
    ...
    void Bearings::declare_parameters(ParameterHandler &prm,const std::string subsection )
    {
      prm.enter_subsection("Bearings");
      {
        prm.enter_subsection(subsection);
        {
            ...
            {
                prm.enter_subsection("Equivalent Springs");
                {
                  prm.declare_entry ("Equivalent Stiffness z",
                                      "500000",
                                      Patterns::Double(0.0),
                                      "Equivalent Stiffness of the bearing in kN/m");
                  prm.enter_subsection("Equivalent Springs Z Area");
                  {
                      prm.declare_entry ("Distance from Start of Bearing",
                                          "0.1",
                                          Patterns::Double(0.0),
                                          "Distance from the start of the bearing");
                      prm.declare_entry ("Distance from End of Bearing",
                                          "0.1",
                                          Patterns::Double(0.0),
                                          "Distance from the end of the bearing");
                      prm.declare_entry ("Distance from Center of Bearing left",
                                          "0.1",
                                          Patterns::Double(0.0),
                                          "Distance from the center of bearing left");
                      prm.declare_entry ("Distance from Center of Bearing right",
                                          "0.1",
                                          Patterns::Double(0.0),
                                          "Distance from the center of bearing right");
                      prm.declare_entry ("Distance from Bottom of Bearing Max",
                                          "0.1",
                                          Patterns::Double(0.0),
                                          "Distance from the bottom of the bearing max");     
                      prm.declare_entry ("Distance from Bottom of Bearing Min",
                                          "0.1",
                                          Patterns::Double(0.0),
                                          "Distance from the bottom of the bearing min");
                  }
                  prm.leave_subsection();
                  prm.declare_entry ("Equivalent Stiffness y",
                                      ...
                                      Patterns::Double(0.0),
                                      "Equivalent Stiffness of the bearing in kN/m");
                  prm.enter_subsection("Equivalent Springs Y Area");
                  {
                      prm.declare_entry ("Distance from Start of Bearing",
                                          "0.1",
                                          Patterns::Double(0.0),
        ...
        prm.enter_subsection("Journal");
        {
              ...
              prm.enter_subsection("Equivalent Springs");
                {
                  ...
                  prm.enter_subsection("Equivalent Springs Z Area");
                  {
                      z_spring_x_max_journal = prm.get_double("Distance from Start of Bearing");
                      z_spring_x_min_journal = prm.get_double("Distance from End of Bearing");
                      z_spring_y_max_journal = prm.get_double("Distance from Center of Bearing left");
                      z_spring_y_min_journal = prm.get_double("Distance from Center of Bearing right");
                      z_damper_z_max_journal = prm.get_double("Distance from Bottom of Bearing Max");     
                      z_damper_z_min_journal = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                   k_equiv_y_journal = prm.get_double("Equivalent Stiffness y")*1000;
                  prm.enter_subsection("Equivalent Springs Y Area");
                  {
                      y_spring_x_max_journal = prm.get_double("Distance from Start of Bearing");
                      y_spring_x_min_journal = prm.get_double("Distance from End of Bearing");
                      y_spring_y_max_journal = prm.get_double("Distance from Center of Bearing left");
                      y_spring_y_min_journal = prm.get_double("Distance from Center of Bearing right");
                      y_spring_z_max_journal = prm.get_double("Distance from Bottom of Bearing Max"); 
                      y_spring_z_min_journal = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                }
                prm.leave_subsection();
            ...
            prm.enter_subsection("Displacement");
            {
                prm.enter_subsection("Bearing 1st Displacement");
                {
                    ...
                    displacement_journal_no1_direction = prm.get_integer("Direction")-1;
                ...
                prm.enter_subsection("Bearing 2nd Displacement");
                {
                    ...
                    displacement_journal_no2_direction = prm.get_integer("Direction")-1;
        ...
        prm.enter_subsection("TailTube");
        {
            ...
            prm.enter_subsection("Fluid");
            {
                prm.enter_subsection("Equivalent Springs");
                {
                  ...
                  prm.enter_subsection("Equivalent Springs Z Area");
                  {
                      z_spring_x_max_tailtube = prm.get_double("Distance from Start of Bearing");
                      z_spring_x_min_tailtube = prm.get_double("Distance from End of Bearing");
                      z_spring_y_max_tailtube = prm.get_double("Distance from Center of Bearing left");
                      z_spring_y_min_tailtube = prm.get_double("Distance from Center of Bearing right");
                      z_spring_z_max_tailtube = prm.get_double("Distance from Bottom of Bearing Max");     
                      z_spring_z_min_tailtube = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                   k_equiv_y_tailtube = prm.get_double("Equivalent Stiffness y")*1000;
                  prm.enter_subsection("Equivalent Springs Y Area");
                  {
                      y_spring_x_max_tailtube = prm.get_double("Distance from Start of Bearing");
                      y_spring_x_min_tailtube = prm.get_double("Distance from End of Bearing");
                      y_spring_y_max_tailtube = prm.get_double("Distance from Center of Bearing left");
                      y_spring_y_min_tailtube = prm.get_double("Distance from Center of Bearing right");
                      y_spring_z_max_tailtube = prm.get_double("Distance from Bottom of Bearing Max"); 
                      y_spring_z_min_tailtube = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                }
                prm.leave_subsection();
            ...
            prm.enter_subsection("Displacement");
            {
                prm.enter_subsection("Bearing 1st Displacement");
                {
                    ...
                    displacement_tailtube_no1_direction = prm.get_integer("Direction")-1;
                ...
                prm.enter_subsection("Bearing 2nd Displacement");
                {
                    ...
                    displacement_tailtube_no2_direction = prm.get_integer("Direction")-1;
        ...
        prm.enter_subsection("SternTube");
        {
            ...
            prm.enter_subsection("Fluid");
            {
                prm.enter_subsection("Equivalent Springs");
                {
                  ...
                  prm.enter_subsection("Equivalent Springs Z Area");
                  {
                      z_spring_x_max_sterntube = prm.get_double("Distance from Start of Bearing");
                      z_spring_x_min_sterntube = prm.get_double("Distance from End of Bearing");
                      z_spring_y_max_sterntube = prm.get_double("Distance from Center of Bearing left");
                      z_spring_y_min_sterntube = prm.get_double("Distance from Center of Bearing right");
                      z_spring_z_max_sterntube = prm.get_double("Distance from Bottom of Bearing Max");     
                      z_spring_z_min_sterntube = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                   k_equiv_y_sterntube = prm.get_double("Equivalent Stiffness y")*1000;
                  prm.enter_subsection("Equivalent Springs Y Area");
                  {
                      y_spring_x_max_sterntube = prm.get_double("Distance from Start of Bearing");
                      y_spring_x_min_sterntube = prm.get_double("Distance from End of Bearing");
                      y_spring_y_max_sterntube = prm.get_double("Distance from Center of Bearing left");
                      y_spring_y_min_sterntube = prm.get_double("Distance from Center of Bearing right");
                      y_spring_z_max_sterntube = prm.get_double("Distance from Bottom of Bearing Max"); 
                      y_spring_z_min_sterntube = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                }
                prm.leave_subsection();
            ...
            prm.enter_subsection("Displacement");
            {
                prm.enter_subsection("Bearing 1st Displacement");
                {
                    ...
                    displacement_sterntube_no1_direction = prm.get_integer("Direction")-1;
                ...
                prm.enter_subsection("Bearing 2nd Displacement");
                {
                    ...
                    displacement_sterntube_no2_direction = prm.get_integer("Direction")-1;
        ...
        prm.enter_subsection("EngineBearings");
        {
            ...
            prm.enter_subsection("Fluid");
            {
                prm.enter_subsection("Equivalent Springs");
                {
                  ...
                  prm.enter_subsection("Equivalent Springs Z Area");
                  {
                      z_spring_x_max_engine = prm.get_double("Distance from Start of Bearing");
                      z_spring_x_min_engine = prm.get_double("Distance from End of Bearing");
                      z_spring_y_max_engine = prm.get_double("Distance from Center of Bearing left");
                      z_spring_y_min_engine = prm.get_double("Distance from Center of Bearing right");
                      z_spring_z_max_engine = prm.get_double("Distance from Bottom of Bearing Max");     
                      z_spring_z_min_engine = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                   k_equiv_y_engine = prm.get_double("Equivalent Stiffness y")*1000;
                  prm.enter_subsection("Equivalent Springs Y Area");
                  {
                      y_spring_x_max_engine = prm.get_double("Distance from Start of Bearing");
                      y_spring_x_min_engine = prm.get_double("Distance from End of Bearing");
                      y_spring_y_max_engine = prm.get_double("Distance from Center of Bearing left");
                      y_spring_y_min_engine = prm.get_double("Distance from Center of Bearing right");
                      y_spring_z_max_engine = prm.get_double("Distance from Bottom of Bearing Max"); 
                      y_spring_z_min_engine = prm.get_double("Distance from Bottom of Bearing Min");
                  }
                  prm.leave_subsection();
                }
                prm.leave_subsection();
            ...
            prm.enter_subsection("Displacement");
            {
                prm.enter_subsection("Bearing 1st Displacement");
                {
                    ...
                    displacement_engine_no1_direction = prm.get_integer("Direction")-1;
                ...
                prm.enter_subsection("Bearing 2nd Displacement");
                {
                    ...
                    displacement_engine_no2_direction = prm.get_integer("Direction")-1;
 ...
 struct Bearing {
    ...
    double phi;
    double k_equiv_z;
    double z_spring_x_max;
    double z_spring_x_min;
    double z_spring_y_max;
    double z_spring_y_min;
    double z_spring_z_max;
    double z_spring_z_min;  
    double k_equiv_y;
    double y_spring_x_max;
    double y_spring_x_min;
    double y_spring_y_max;
    double y_spring_y_min;
    double y_spring_z_max;
    double y_spring_z_min;
...
std::map<types::boundary_id, Bearing> combineBearingsMap(const std::map<types::boundary_id, Bearing>& bearings1,
                                       const std::map<types::boundary_id, Bearing>& bearings2,
                                       const std::map<types::boundary_id, Bearing>& bearings3,
                                       const std::map<types::boundary_id, Bearing>& bearings4) {
    std::map<types::boundary_id, Bearing> combinedBearings;
...
std::map<types::boundary_id, Bearing> calculateBearingsMap(int numBearings, 
                                            double distanceBetween, 
                                            double bearingLength, 
                                            double x_first_bearing,
                                            double radius_shaft, 
                                            ...
                                            double displacement_2_endtime,
                                            int boundary_id_first) {
    std::map<types::boundary_id, Bearing> bearingsMap;
    double currentPosition = x_first_bearing;
                                  ...
                                  const unsigned int       q_point)
{
  ...
  private:
    ...
    void change_diameter(/*Triangulation<dim> &triangulation, */const double x_1, const double x_2,const double original_radius, const double radius_final, bool refine_x0, bool refine_x1);
   ...
   // Vector<double> locally_relevant_solution;
    ...
    std::map<types::boundary_id, Bearing>  journal_bearings   ;
    std::map<types::boundary_id, Bearing>  tailtube_bearings ;
    std::map<types::boundary_id, Bearing>  sterntube_bearings;
    std::map<types::boundary_id, Bearing>  engine_bearings   ;
...
double calculate_cylinder_radius(double length, double mass_moment_of_inertia,  double density) {
...
double calculate_cylinder_density(double length,  double mass_moment_of_inertia,  double radius) {
    double density;
    if (radius <= 0 || length <= 0 || mass_moment_of_inertia <= 0) {
       ...
       density = (2 * mass_moment_of_inertia) / (M_PI * radius * radius* radius * radius * length);
    return density;
}
double calculateCylinderDensity_mass(double length, double mass, double radius) {
    // Check for zero or negative values to avoid division by zero or invalid calculations
     double volume;
    if (length <= 0 || mass <= 0 || radius <= 0) {
        volume = 0;
        //throw std::invalid_argument("Length, mass, and radius must be positive values.");
    }
...
template <int dim>
std::map<types::boundary_id, std::pair<double, double>> getAllBearingSpringK(const std::map<types::boundary_id, Bearing>& bearings, const DoFHandler<dim> &dof_handler) {
    ...
    for (const auto& bearingEntry : bearings) {
        ...
        const Point<dim> max_coordinate_z(bearing.end_position    -bearing.z_spring_x_max,     bearing.radius_shaft     -bearing.z_spring_y_max,       -bearing.radius_shaft      +bearing.z_spring_z_max     );
        const Point<dim> min_coordinate_z(bearing.start_position  +bearing.z_spring_x_min,    -bearing.radius_shaft     +bearing.z_spring_y_min,       -bearing.radius_shaft      +bearing.z_spring_z_min     );
        const Point<dim> max_coordinate_y(bearing.end_position    -bearing.y_spring_x_max,     bearing.radius_shaft     -bearing.y_spring_y_max,       -bearing.radius_shaft      +bearing.y_spring_z_max     );
        const Point<dim> min_coordinate_y(bearing.start_position  +bearing.y_spring_x_min,    -bearing.radius_shaft     +bearing.y_spring_y_min,       -bearing.radius_shaft      +bearing.y_spring_z_min     );
        //std::cout << "Point max: " << max_coordinate_z<< std::endl;
       // std::cout << "Point min: " << min_coordinate_z<< std::endl;
        ...
        //std::cout << "Area z: " << area_z<< std::endl;
        //std::cout << "Area y: " << area_y<< std::endl;
        //std::cout << "Centroid Area z: " << std::get<1>(result_1)<< std::endl;
...
std::map<types::boundary_id, Shaft> combineShaftsToMap(const Shaft& shaft1, const Shaft& shaft2, const Shaft& shaft3, const Shaft& shaft4) {
    std::map<types::boundary_id, Shaft> shaftMap;
...
std::map<types::boundary_id, Shaft> combineAddedMassesToMap(const Shaft& shaft1, const Shaft& shaft2) {
    std::map<types::boundary_id, Shaft> shaftMap;
...
//}
template <int dim>
int getBoundaryIdForXCoordinateBearing(const std::map< types::boundary_id, Bearing>& bearingsMap, double xCoordinate) {
...
//}
template <int dim>
int getBoundaryIdForXCoordinateShaft(const std::map<types::boundary_id, Shaft>& shafts, double xCoordinate) {
...
template <int dim>
std::map<int, std::pair<double, Point<dim>>> getAllBearingSpringAreaZ(const std::map<types::boundary_id, Bearing>& bearings, const DoFHandler<dim> &dof_handler) {
...
//
    ...
    pcout << "Plus Half Length = "<<plus_half_length << std::flush;
   // partitions = ceilDiv(prm.partitions,partitions_divider);
    double halflength = 0;
     if(prm.useShaft_propellershaft) 
            halflength += prm.length_propellershaft/2;
    if (prm.useShaft_engineshaft)
            halflength += prm.length_engineshaft/2;
    if (prm.useShaft_thrustshaft)
            halflength += prm.length_thrustshaft/2;
    if (prm.useShaft_intermediateshaft)
            halflength += prm.length_intermediateshaft/2;
    //if (prm.useShaft_intermediateshaft)
        ...
        GridGenerator::subdivided_cylinder(triangulation, prm.partitions, prm.radius_intermediateshaft, halflength);
        GridTools::partition_triangulation (n_mpi_processes,
                                           triangulation);
       const double x0 = -halflength;
       const double x1 =  halflength;
       ...
       double dist=0;
        ...
        if (prm.useShaft_propellershaft)
            dist = prm.distance_from_point_propellershaft+halflength;
        else
            dist = prm.distance_from_point_intermediateshaft+halflength;

        if (minus_half_length<=0)
          {
            dist += 0.5;
            minus_half_length = 0.5;
          }
     ...
     {
      change_diameter(prm.x_1,prm.x_2,prm.radius_intermediateshaft, prm.radius_final,true,true);
    ...
    //
     ...
     journal_bearings   = calculateBearingsMap(prm.bearings_journal,   
                                            ...
                                            prm.z_spring_x_max_journal,
                                            prm.z_spring_x_min_journal,
                                            prm.z_spring_y_max_journal,
                                            prm.z_spring_y_min_journal,
                                            prm.z_damper_z_max_journal,
                                            prm.z_damper_z_min_journal,
                                            prm.k_equiv_y_journal,
                                            prm.y_spring_x_max_journal,
                                            prm.y_spring_x_min_journal,
                                            prm.y_spring_y_max_journal,
                                            prm.y_spring_y_min_journal,
                                            prm.y_spring_z_max_journal,
                                            prm.y_spring_z_min_journal,                             
    ...
    tailtube_bearings  = calculateBearingsMap(prm.bearings_tailtube,  
                                            ...
                                            prm.z_spring_x_max_tailtube,
                                            prm.z_spring_x_min_tailtube,
                                            prm.z_spring_y_max_tailtube,
                                            prm.z_spring_y_min_tailtube,
                                            prm.z_spring_z_max_tailtube,
                                            prm.z_spring_z_min_tailtube,
                                            prm.k_equiv_y_tailtube,
                                            prm.y_spring_x_max_tailtube,
                                            prm.y_spring_x_min_tailtube,
                                            prm.y_spring_y_max_tailtube,
                                            prm.y_spring_y_min_tailtube,
                                            prm.y_spring_z_max_tailtube,
                                            prm.y_spring_z_min_tailtube,                                       
    ...
    sterntube_bearings = calculateBearingsMap(prm.bearings_sterntube, 
                                            ...
                                            prm.z_spring_x_max_sterntube,
                                            prm.z_spring_x_min_sterntube,
                                            prm.z_spring_y_max_sterntube,
                                            prm.z_spring_y_min_sterntube,
                                            prm.z_spring_z_max_sterntube,
                                            prm.z_spring_z_min_sterntube,
                                            prm.k_equiv_y_sterntube,
                                            prm.y_spring_x_max_sterntube,
                                            prm.y_spring_x_min_sterntube,
                                            prm.y_spring_y_max_sterntube,
                                            prm.y_spring_y_min_sterntube,
                                            prm.y_spring_z_max_sterntube,
                                            prm.y_spring_z_min_sterntube,
    ...
    engine_bearings    = calculateBearingsMap(prm.bearings_engine,    
                                            ...
                                            prm.z_spring_x_max_engine,
                                            prm.z_spring_x_min_engine,
                                            prm.z_spring_y_max_engine,
                                            prm.z_spring_y_min_engine,
                                            prm.z_spring_z_max_engine,
                                            prm.z_spring_z_min_engine,
                                            prm.k_equiv_y_engine,
                                            prm.y_spring_x_max_engine,
                                            prm.y_spring_x_min_engine,
                                            prm.y_spring_y_max_engine,
                                            prm.y_spring_y_min_engine,
                                            prm.y_spring_z_max_engine,
                                            prm.y_spring_z_min_engine,
    ...
    std::map<types::boundary_id, Bearing> allBearings = combineBearingsMap(journal_bearings, tailtube_bearings, sterntube_bearings, engine_bearings);
    if (prm.useShaft_thrustshaft)
    {
        ...
        bool refine_x1 = (prm.radius_thrustshaft==prm.radius_intermediateshaft) ? false : true;
        bool refine_x2 = (prm.radius_thrustshaft==prm.radius_intermediateshaft) ? false : true;
         change_diameter(prm.distance_from_point_thrustshaft,prm.length_thrustshaft/2+prm.distance_from_point_thrustshaft+(prm.useShaft_engineshaft)?0:0.1,prm.radius_intermediateshaft, prm.radius_thrustshaft, refine_x1, refine_x2);
        triangulation.execute_coarsening_and_refinement();
    ...
    if (prm.useShaft_engineshaft)
    {
        if (prm.radius_engineshaft==0&&prm.mass_inertia_engineshaft>0)
        {
            ...
            prm.radius_engineshaft = radius_engineshaft;
                ...
                bool refine_x1 = (prm.radius_engineshaft==prm.radius_intermediateshaft) ? false : true;
        bool refine_x2 = (prm.radius_engineshaft==prm.radius_intermediateshaft) ? false : true;
        change_diameter(prm.distance_from_point_engineshaft,prm.length_engineshaft/2+prm.distance_from_point_engineshaft+0.5,prm.radius_intermediateshaft, prm.radius_engineshaft,refine_x1, refine_x2);
        triangulation.execute_coarsening_and_refinement();
    ...
    if (prm.useShaft_propellershaft)
    {
        ...
        //bool refine_x1 = (prm.radius_propellershaft==prm.radius_intermediateshaft) ? false : true;
        bool refine_x2 = (prm.radius_propellershaft==prm.radius_intermediateshaft) ? false : true;
        change_diameter(prm.distance_from_point_propellershaft-0.5,prm.length_propellershaft/2+prm.distance_from_point_propellershaft,prm.radius_intermediateshaft, prm.radius_propellershaft,false,refine_x2);
        triangulation.execute_coarsening_and_refinement();
        //
        ...
        if (cell->face(f)->at_boundary())
          {
                 ...
                 //   prm.radius_intermediateshaft)
            {
                ...
                if (prm.useShaft_propellershaft)
                {
                    if ( dist_vector[0] <= prm.distance_from_point_propellershaft+prm.length_propellershaft)
                    {
                ...
                if (dist_vector[0]>=minus_half_length && dist_vector[0]<=minus_half_length+prm.prop_length)
                    {
   ...
   template <int dim>
  void  TopLevel<dim>::change_diameter(/*Triangulation<dim> &triangulation,*/ const double x_1, const double x_2,const double original_radius, const double radius_final, bool refine_x0, bool refine_x1)
  {
            ...
            if (vertex_touched[cell->vertex_index(v)] == false)
              {
                ...
                if (abs(point(0)-x_1)<0.1 && refine_x0)
                  cell->set_refine_flag();
                if (abs(point(0)-x_2)<0.1 && refine_x1)
                  cell->set_refine_flag();
              }
        triangulation.execute_coarsening_and_refinement();
    }
 ...
 void TopLevel<dim>::compute_dirichlet_constraints()
 {
  ...
  void TopLevel<dim>::assemble_system()
  {
   ...
   // pcout <<  "\n        Area of journal bearing spring: "<< std::get<0>(boundaryAreaZMap[7]) << " with centroid=  " << std::get<1>(boundaryAreaZMap[7]) <<std::flush;
    ...
    std::map<types::boundary_id,Shaft> allShafts = combineShaftsToMap(intermediate_shaft, thrust_shaft, engine_shaft, propeller_shaft);
    double prop_rho4moment = calculate_cylinder_density(prm.prop_length, 
                                          prm.prop_mass_moment_inertia, 
                                         prm.radius_propellershaft);
    double prop_mass4moment = prop_rho4moment*M_PI* prm.radius_propellershaft*prm.prop_length;
    //pcout <<  "\n        Prop rho =  "<<  prop_rho4moment<<std::flush;

    // pcout <<  "\n        Prop mass =  "<<  prop_mass4moment<<std::flush;
     double prop_volume = M_PI * prm.radius_propellershaft*prm.radius_propellershaft*prm.prop_length;

    Shaft prop4moment = createShaft(true,
                                            prm.distance_from_point_propellershaft,
                                            prm.prop_length,
                                            prm.radius_propellershaft,
                                            prop_rho4moment,
    ...
    double prop_rho4gravity = (prop_volume>0)?prm.prop_weight/prop_volume:0;
    Shaft prop4gravity = createShaft(true,
                                            prm.distance_from_point_propellershaft,
                                            prm.prop_length,
                                            prm.radius_propellershaft,
                                            prop_rho4gravity,
                                            ...
                                            quadrature_formula);
    double flywheel_radius ;
    double flywheel_rho4moment;
    if (prm.flywheel_radius<=0&&prm.flywheel_density<=0){
      flywheel_radius = allShafts[getBoundaryIdForXCoordinateShaft<dim>(allShafts,prm.flywheel_distance_from_point)].radius_shaft;
      flywheel_rho4moment = calculate_cylinder_density(prm.flywheel_length, 
                                          prm.flywheel_mass_moment_inertia, 
                                          flywheel_radius);
    }
    else 
    {
        flywheel_radius = prm.flywheel_radius;
        flywheel_rho4moment = prm.flywheel_density;
    }
     

    Shaft flywheel4moment = createShaft(prm.useFlywheel,
                                            prm.flywheel_distance_from_point,
                                            prm.flywheel_length,
                                            flywheel_radius,
                                            flywheel_rho4moment,
                                            prm.flywheel_mass_moment_inertia,
                                            allShafts[getBoundaryIdForXCoordinateShaft<dim>(allShafts,prm.flywheel_distance_from_point)].boundary_id,
                                            dof_handler,
                                            quadrature_formula);     
    std::map<types::boundary_id,Shaft> addedMassShafts = combineAddedMassesToMap(prop4moment, flywheel4moment);  
    std::map<types::boundary_id,Shaft> addedBodyForceShafts = combineAddedMassesToMap(prop4gravity, flywheel4moment);  
    ...
    pcout <<  "\n           Stiffness of bearing: "<< std::get<0>(boundaryStiffenessMap[getBoundaryIdForXCoordinateBearing<dim>(allBearings,2.5)])<<std::flush;
      ...
      if (cell->subdomain_id() == this_mpi_process)
        {
          ...
          BodyForce<dim>              body_force(1, prm.g);
        ...
        springbearingLHS<dim> journal_bearing_spring_z(1,dim-1); 
        springbearingLHS<dim> journal_bearing_spring_y(1,dim-2); 

        std::vector<Vector<double>> journal_bearing_spring_values_z(n_q_points,
                                                     Vector<double>(dim));  
         std::vector<Vector<double>> journal_bearing_spring_values_y(n_q_points,
                                                     Vector<double>(dim));                                                
              ...
              for (unsigned int q_point = 0; q_point < n_q_points; ++q_point)
                {
                  ...
                  cell_mass_matrix(i, j) +=(allShafts[getBoundaryIdForXCoordinateShaft<dim>(allShafts,point(0))].density+addedMassShafts[getBoundaryIdForXCoordinateShaft<dim>(addedMassShafts,point(0))].density)* (
          ...
          for (unsigned int face = 0; face < n_faces_per_cell; ++face)
            if (cell->face(face)->at_boundary() && (cell->face(face)->boundary_id() >6))
              {
                fe_face_values.reinit(cell, face);
                journal_bearing_spring_z.vector_value_list(fe_face_values.get_quadrature_points(), 
                                                                    journal_bearing_spring_values_z);
                journal_bearing_spring_y.vector_value_list(fe_face_values.get_quadrature_points(),
                                                                    journal_bearing_spring_values_y);
                ...
                for (unsigned int q_point = 0; q_point < fe_face_values.n_quadrature_points;++q_point)
                    {
                        ...
                        //Point<dim> min_coordinate_z (allBearings[boundary_id].start_position,-allBearings[boundary_id].radius_shaft,-allBearings[boundary_id].radius_shaft);
                        //Point<dim> max_coordinate_z (allBearings[boundary_id].end_position,allBearings[boundary_id].radius_shaft,-0.8*allBearings[boundary_id].radius_shaft);
                        Point<dim> max_coordinate_z(allBearings[boundary_id].end_position    -allBearings[boundary_id].z_spring_x_max,     allBearings[boundary_id].radius_shaft     -allBearings[boundary_id].z_spring_y_max,       -allBearings[boundary_id].radius_shaft      +allBearings[boundary_id].z_spring_z_max     );
                        Point<dim> min_coordinate_z(allBearings[boundary_id].start_position  +allBearings[boundary_id].z_spring_x_min,    -allBearings[boundary_id].radius_shaft     +allBearings[boundary_id].z_spring_y_min,       -allBearings[boundary_id].radius_shaft      +allBearings[boundary_id].z_spring_z_min     );
                        Point<dim> max_coordinate_y(allBearings[boundary_id].end_position    -allBearings[boundary_id].y_spring_x_max,     allBearings[boundary_id].radius_shaft     -allBearings[boundary_id].y_spring_y_max,       -allBearings[boundary_id].radius_shaft      +allBearings[boundary_id].y_spring_z_max     );
                        Point<dim> min_coordinate_y(allBearings[boundary_id].start_position  +allBearings[boundary_id].y_spring_x_min,    -allBearings[boundary_id].radius_shaft     +allBearings[boundary_id].y_spring_y_min,       -allBearings[boundary_id].radius_shaft      +allBearings[boundary_id].y_spring_z_min     );
                        if(point_inside_box(point, min_coordinate_z, max_coordinate_z))
                        {
                            for (unsigned int i = 0; i < dim; ++i)
                                {
                                    rhs_values[i][i] = std::get<0>(boundaryStiffenessMap[getBoundaryIdForXCoordinateBearing<dim>(allBearings,point[0])])*journal_bearing_spring_values_z[q_point][i];
                                }
                            for (unsigned int i = 0; i < dofs_per_cell; ++i)
                            for (unsigned int j = 0; j < dofs_per_cell; ++j)
                        ...
                        if(point_inside_box(point, min_coordinate_y, max_coordinate_y))
                        {
                            for (unsigned int i = 0; i < dim; ++i)
                                {
                                    rhs_values[i][i] = std::get<1>(boundaryStiffenessMap[getBoundaryIdForXCoordinateBearing<dim>(allBearings,point[0])])*journal_bearing_spring_values_y[q_point][i];
                                }
                            for (unsigned int i = 0; i < dofs_per_cell; ++i)
                            for (unsigned int j = 0; j < dofs_per_cell; ++j)
              ...
              for (unsigned int q_point = 0; q_point < n_q_points; ++q_point)
                {
                  ...
                  //for (unsigned int i = 0; i < dim; ++i)
                      cell_res(i) += old_stress * get_strain(fe_values, i, q_point)* fe_values.JxW(q_point);
                         ...
                         //   * fe_values.JxW(q_point);
                        cell_rhs(i) +=(allShafts[getBoundaryIdForXCoordinateShaft<dim>(allShafts,point(0))].density
                                      +addedBodyForceShafts[getBoundaryIdForXCoordinateShaft<dim>(addedMassShafts,point(0))].density)*
                                      body_force_values[q_point](component_i)*fe_values.shape_value(i, q_point)*fe_values.JxW(q_point);//  -old_stress * get_strain(fe_values, i, q_point)* fe_values.JxW(q_point) ;
...
//
                    //        }
                    //}
                  //else if (cell->face(face)->at_boundary() && cell->face(face)->boundary_id() >=7 && prm.dynamicmode && !prm.useReynolds )
                  //  {
                  //      
...
//
     //   pcout << "        Residual Linear Calculating." <<std::flush; 
     //   system_rhs.compress(VectorOperation::add);
  ...
  //if (timestep_no==0)
    {
        ...
        data_out_faces.write_vtu_in_parallel(
